...
private:
	...
	private slots:
		...
		void ChangeTrackStyle(QString type);
		void ChangeStyleToClassic();
		void ChangeStyleToSimple();
		void ChangeStyleToRoller();
		...
		void AddCar();
		void RemoveCar();
		void MVViewPosForward();
		void MVViewPosBackward();
		void ChangeSpeedOfTrain( int val );
		void ChangeSleeperVisible(bool);
		void ChangePhysis(bool);
		void ChangeSleeperFrqtOfTrain(int val);
		void ChangeSplineTension(int val);
		void ChangeSplineSubdivision(int val);
